...
import { BellRing, DatabaseBackup, LogOut, ChevronRight, FlaskConical, Tag } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <nav className="flex flex-col divide-y divide-cream-200 overflow-hidden rounded-xl2 bg-white shadow-card">
        <Link to="/more/products" className="flex items-center gap-3 px-4 py-4">
          <Tag className="h-5 w-5 text-berry-500" aria-hidden />
          <span className="flex-1 text-cocoa-700">Product Rates</span>
